...
<div class="space-y-6">
    <section class="card p-5 rounded-xl">
        <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
            ...
            <a href="{{ route('admin.aksesoris.create') }}" class="inline-flex items-center justify-center px-4 py-2 rounded-lg btn-primary hover:bg-[var(--mh-primary-600)] transition">
                + Tambah Aksesoris
            </a>
        </div>
        ...
        <form method="GET" action="{{ route('admin.aksesoris.index') }}" class="mt-5 grid grid-cols-1 md:grid-cols-3 gap-3">
            <input
                type="text"
                name="search"
                        ...
                        <tr class="border-b border-[var(--mh-border)] last:border-b-0">
                            ...
                            <td class="py-3 pr-3">
                                <div class="flex items-center gap-2">
                                    <a href="{{ route('admin.aksesoris.show', $product->id) }}" class="px-3 py-1.5 rounded-md border border-[var(--mh-primary-600)] text-[var(--mh-primary)] hover:bg-[var(--mh-surface-hover)]">Detail</a>

                                    <a href="{{ route('admin.aksesoris.edit', $product->id) }}" class="px-3 py-1.5 rounded-md border border-[var(--mh-border)] text-[var(--mh-muted)] hover:bg-[var(--mh-surface-hover)]">Edit</a>
