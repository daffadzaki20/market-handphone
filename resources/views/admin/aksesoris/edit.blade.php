...
<div class="max-w-4xl mx-auto">
    <section class="card p-6 rounded-xl">
        ...
        <form action="{{ route('admin.aksesoris.update', $product->id) }}" method="POST" enctype="multipart/form-data" class="space-y-5">
            @csrf
            @method('PUT')
            ...
            <div class="flex items-center gap-3 pt-2">
                ...
                <a href="{{ route('admin.aksesoris.index') }}" class="px-4 py-2 rounded-lg border border-[var(--mh-border)] text-[var(--mh-muted)] hover:bg-[var(--mh-surface-hover)] transition">Batal</a>
            </div>
        </form>
    </section>
</div>
