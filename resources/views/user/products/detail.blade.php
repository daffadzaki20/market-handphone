        ...
        <div class="bg-white rounded-3xl shadow-sm border border-gray-100 overflow-hidden">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8 p-6 md:p-10">
                ...
                <div class="flex justify-center items-center mb-6 md:mb-0 relative">
                    ...
                    <a href="{{ $brandType === 'aksesoris' ? '/products/aksesoris' : '/products/handphone' }}" class="absolute top-0 left-0 bg-white/80 backdrop-blur-sm border border-gray-200 text-gray-600 hover:text-blue-600 p-2 rounded-xl transition-colors shadow-sm md:hidden">
                ...
                <div class="flex flex-col justify-center">
                    ...
                    <div class="mt-auto flex flex-col sm:flex-row gap-4">
                        ...
                        @endphp
                        <button onclick="toggleWishlistApp({{ $product->id }}, this)" 
                                class="flex flex-none items-center justify-center bg-white hover:bg-gray-50 border border-gray-200 transition-all text-gray-700 py-4 px-6 rounded-xl font-bold shadow-sm hover:shadow-md" title="Wishlist">
                            <svg class="w-6 h-6 {{ $inWishlist ? 'fill-red-500 text-red-500' : 'text-gray-400 fill-transparent' }} transition-colors" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                                <path stroke-linecap="round" stroke-linejoin="round" d="M4.318 6.318a4.5 4.5 0 000 6.364L12 20.364l7.682-7.682a4.5 4.5 0 00-6.364-6.364L12 7.636l-1.318-1.318a4.5 4.5 0 00-6.364 0z"></path>
                            </svg>
                        </button>

                        <a href="{{ $brandType === 'aksesoris' ? '/products/aksesoris' : '/products/handphone' }}" class="hidden md:flex flex-none bg-white hover:bg-gray-50 border border-gray-200 transition-all text-gray-700 py-4 px-8 rounded-xl font-bold items-center justify-center shadow-sm hover:shadow-md">
                            Kembali
                        </a>
                    </div>
