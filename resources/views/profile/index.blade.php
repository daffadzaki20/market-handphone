...
<div class="max-w-6xl mx-auto px-4 py-8 flex flex-col md:flex-row gap-8">
    ...
    <div class="w-full md:w-1/4">
        ...
        <nav class="space-y-5 text-sm">
            ...
            <!-- Menu Lainnya (Dummy untuk tampilan visual) -->
    ...
    <div class="w-full md:w-3/4 bg-white shadow-sm border border-gray-100 rounded-md p-6 md:p-8">
        ...
        <div class="flex flex-col-reverse md:flex-row gap-8">
            ...
            <div class="flex-1 md:pr-12 md:border-r border-gray-200">
                ...
                <!-- Blok Error (PENTING untuk mengetahui alasan gagal simpan) -->
                @if ($errors->any())
                ...
                <!-- Arahkan ke rute update dan wajib ada @csrf -->
                    ...
                    <div class="flex flex-col sm:flex-row sm:items-center mb-6">
                        ...
                        <div class="sm:w-2/3 text-sm text-gray-800">
                            <input type="email" 
                                   ...
                                   class="w-full border border-gray-300 rounded-sm px-3 py-2 text-sm focus:border-orange-500 focus:ring-1 focus:ring-orange-500 outline-none transition-colors">
                        </div>
                    </div>

                    <!-- Phone Number (Langsung Tampil Input) -->
                    <div class="flex flex-col sm:flex-row sm:items-center mb-6">
                        ...
                        <div class="sm:w-2/3 text-sm">
                            <input type="tel" 
                                   ...
                                   class="w-full border border-gray-300 rounded-sm px-3 py-2 text-sm focus:border-orange-500 outline-none">
                        </div>
                    </div>
