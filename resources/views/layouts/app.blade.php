        ...
        <nav x-data="{ mobileMenuOpen: false }" class="bg-white shadow-md relative z-[50]">
            <div class="max-w-7xl mx-auto px-4 py-3 flex justify-between items-center">
                ...
                <div class="hidden md:flex space-x-8 text-sm font-bold">
                   ...
                   {{-- Pesanan, Wishlist, dan Notifikasi dengan Badge Angka (Hanya untuk user login) --}}
                    @auth
                        @php
                        ...
                        {{-- Menu Pesanan Saya --}}
                        <a href="{{ route('orders.index') }}" class="relative pb-1 transition-colors duration-200 {{ request()->is('orders') ? 'text-blue-600 border-b-2 border-blue-600' : 'text-gray-500 hover:text-blue-500' }}">
                            Pesanan Saya
                        ...
                        {{-- Menu Wishlist --}}
                        <a href="{{ route('wishlist.index') }}" class="relative pb-1 transition-colors duration-200 {{ request()->is('wishlist') ? 'text-blue-600 border-b-2 border-blue-600' : 'text-gray-500 hover:text-blue-500' }}">
                            Wishlist
                            @if($wishlistCount > 0)
                ...
                <div class="flex items-center gap-4 sm:gap-5">
                    ...
                    @auth
                        <a href="{{ route('profile.notifications') }}" class="relative text-gray-400 hover:text-orange-500 transition-colors">
                            ...
                            {{-- Menampilkan angka notifikasi HANYA JIKA ADA NOTIFIKASI BARU ($newNotifCount) --}}
                            @if($newNotifCount > 0)
                    ...
                    @auth
                        @php
                            ...
                            $wishlistCount = \App\Models\Wishlist::where('user_id', Auth::id())
                                ->count();
                        @endphp
                        <a href="{{ route('orders.index') }}" class="flex items-center justify-between px-4 py-3 rounded-xl font-bold {{ request()->is('orders') ? 'bg-blue-50 text-blue-600' : 'text-gray-600 hover:bg-gray-50 hover:text-blue-600' }}">
                        ...
                        <a href="{{ route('wishlist.index') }}" class="flex items-center justify-between px-4 py-3 rounded-xl font-bold {{ request()->is('wishlist') ? 'bg-blue-50 text-blue-600' : 'text-gray-600 hover:bg-gray-50 hover:text-blue-600' }}">
