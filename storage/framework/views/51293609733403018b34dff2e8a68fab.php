<?php $__env->startSection('content'); ?>
    ...
    <div class="py-8 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <form method="GET" action="<?php echo e(route('products.aksesoris')); ?>" class="mb-6 flex gap-3" id="searchForm">
        ...
        <div class="flex flex-wrap gap-2 mb-8">
            <a href="<?php echo e(route('products.aksesoris', array_filter(['search' => request('search')]))); ?>"
            ...
            <a href="<?php echo e(route('products.aksesoris', array_filter(['brand' => $brand->slug, 'search' => request('search')]))); ?>"
               class="px-4 py-1.5 rounded-full text-sm font-medium transition-all shadow-sm
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\projek pak fajar\market-handphone\resources\views/user/products/aksesoris.blade.php ENDPATH**/ ?>