<?php $__env->startSection('content'); ?>
    <div class="max-w-4xl mx-auto px-4 py-8 relative min-h-screen">
        ...
        <?php if($cartItems->isEmpty()): ?>
            ...
            <div class="bg-white rounded-3xl shadow-sm border border-gray-100 p-12 text-center mt-10">
                ...
                <a href="/products/handphone" class="inline-block bg-orange-500 hover:bg-orange-600 shadow-lg shadow-orange-200 text-white font-bold py-3 px-8 rounded-xl transition-transform hover:-translate-y-1">
                    Mulai Belanja
                </a>
            </div>
        <?php else: ?>
            ...
            <div class="space-y-4 mb-8">
                <?php $__currentLoopData = $cartItems; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="bg-white rounded-2xl p-4 shadow-sm border border-gray-100 flex items-center gap-4 transition-all hover:border-orange-300 hover:shadow-md cart-item" 
                        ...
                        <a href="/product/<?php echo e($item->product->id ?? '#'); ?>" class="flex flex-1 items-center gap-4 group">
                            <!-- Gambar Produk -->
                        ...
                        <div class="flex flex-col items-end gap-3 z-10">
                            <!-- Form Hapus Satuan -->
                            <form action="/cart/remove/<?php echo e($item->id); ?>" method="POST" onsubmit="return confirm('Hapus produk ini?')">
    ...
    <form id="bulk-delete-form" action="/cart/bulk-delete" method="POST" class="hidden">
        <?php echo csrf_field(); ?> <?php echo method_field('DELETE'); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\XampUtama\htdocs\handphone\resources\views/cart.blade.php ENDPATH**/ ?>