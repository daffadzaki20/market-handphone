<?php $__env->startSection('title', 'Tambah Handphone'); ?>

<?php $__env->startSection('content'); ?>
<div class="max-w-4xl mx-auto">
    <section class="card p-6 rounded-xl">
        <div class="mb-6">
            <h2 class="text-xl font-bold text-[var(--mh-text)]">Tambah Handphone</h2>
            <p class="text-sm text-[var(--mh-muted)] mt-1">Isi form berikut untuk menambahkan produk handphone baru.</p>
        </div>

        <form action="<?php echo e(route('admin.handphones.store')); ?>" method="POST" enctype="multipart/form-data" class="space-y-5">
            <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.app_admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\S6\PengemWeb\market-handphone\resources\views/admin/handphones/create.blade.php ENDPATH**/ ?>