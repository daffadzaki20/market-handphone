<?php $__env->startSection('content'); ?>
     ...
     <div class="py-8 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
         ...
         <!-- 🔍 SEARCH BAR -->
         <form method="GET" action="<?php echo e(route('products.handphone')); ?>" class="mb-6 flex gap-3" id="searchForm">
        ...
        <div class="flex flex-wrap gap-2 mb-8">
            <a href="<?php echo e(route('products.handphone', array_filter(['search' => request('search')]))); ?>"
            ...
            <a href="<?php echo e(route('products.handphone', array_filter(['brand' => $brand->slug, 'search' => request('search')]))); ?>"
               class="px-4 py-1.5 rounded-full text-sm font-medium transition-all shadow-sm
                       ...
                       class="bg-white rounded-2xl shadow-sm hover:shadow-xl border border-gray-100 transition-all duration-300 overflow-hidden group flex flex-col">
                        ...
                        <div class="h-48 bg-gray-50 flex items-center justify-center overflow-hidden relative p-4">
                            ...
                            <button type="button"
                                    ...
                                    onclick="toggleWishlist(event, <?php echo e($product->id); ?>, this)">
                                <svg class="w-5 h-5 love-icon <?php echo e(in_array($product->id, $wishlistIds ?? []) ? 'text-red-500 fill-red-500' : 'text-gray-400 fill-none'); ?>"
                        ...
                        <div class="p-4 flex flex-col flex-grow">
                            ...
                            <div class="flex items-center justify-between text-[11px] text-gray-500 mt-auto pt-3 border-t border-gray-100">
                                <span class="font-medium">
                                    <?php echo e($product->ram ?? '-'); ?> / <?php echo e($product->storage ?? '-'); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\projek pak fajar\market-handphone\resources\views/user/products/handphone.blade.php ENDPATH**/ ?>