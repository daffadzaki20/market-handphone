...
<div class="max-w-6xl mx-auto px-4 py-6 md:py-8 flex flex-col md:flex-row gap-4 md:gap-3">
    ...
    <div class="w-full md:w-48 flex-shrink-0">
        ...
        <div class="flex items-center gap-3 mb-6 pb-6 border-b border-gray-200">
            ...
            <div class="overflow-hidden">
                ...
                <a href="/profile" class="text-sm text-gray-500 flex items-center gap-1 mt-0.5 hover:text-orange-500 transition-colors">
        ...
        <nav class="space-y-5 text-sm">
            ...
            <a href="/profile/pesanan" class="flex items-center gap-2 font-semibold text-orange-500 transition-colors">
    ...
    <div class="flex-1 bg-white shadow-sm border border-gray-100 rounded-md overflow-hidden">  
        ...
        <!-- Empty State (Tampilan saat belum ada pesanan) -->
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\S6\PengemWeb\market-handphone\resources\views/profile/pesanan.blade.php ENDPATH**/ ?>