<?php $__env->startSection('content'); ?>
    ...
    <div class="py-8 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="flex flex-wrap gap-2 mb-8">
            ...
            <a href="/products/aksesoris?brand=<?php echo e($brand->slug); ?><?php echo e(request('search') ? '&search='.request('search') : ''); ?>"
               class="px-4 py-1.5 rounded-full text-sm font-medium transition-all shadow-sm
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\XampUtama\htdocs\handphone\resources\views/products/aksesoris.blade.php ENDPATH**/ ?>