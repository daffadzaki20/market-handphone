<?php $__env->startSection('title', 'Edit Aksesoris'); ?>
...
<div class="max-w-4xl mx-auto">
    <section class="card p-6 rounded-xl">
        ...
        <form action="/admin/aksesoris/<?php echo e($product->id); ?>" method="POST" enctype="multipart/form-data" class="space-y-5">
            <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.app_admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\XampUtama\htdocs\handphone\resources\views/admin/aksesoris/edit.blade.php ENDPATH**/ ?>