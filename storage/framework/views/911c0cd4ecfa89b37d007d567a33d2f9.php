        ...
        <nav class="space-y-5 text-sm">
            ...
            <div>
                ...
                <div class="pl-7 space-y-3 mt-2">
                    ...
                    <a href="<?php echo e(route('profile.password')); ?>" class="block text-orange-500 font-medium">Ubah Password</a>
                </div>
            </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\projek pak fajar\market-handphone\resources\views/user/profile/password.blade.php ENDPATH**/ ?>