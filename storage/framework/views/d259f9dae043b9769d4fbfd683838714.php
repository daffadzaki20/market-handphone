<?php $__env->startSection('title', 'Login - MyPhoneStore'); ?>
        ...
        <form method="POST" action="<?php echo e(route('login')); ?>" class="space-y-4">
            ...
            <div>
                ...
                <input type="text"
                       ...
                       required autofocus
                       class="w-full border p-3 rounded-lg focus:ring focus:ring-blue-200 outline-none <?php $__errorArgs = ['login'];
...
$message = $__bag->first($__errorArgs[0]); ?>
                    <p class="text-xs text-red-500 mt-1 font-medium"><?php echo e($message); ?></p>
                <?php unset($message);
if (isset($__messageOriginal)) { $message = $__messageOriginal; }
endif;
unset($__errorArgs, $__bag); ?>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="flex justify-between items-center px-1">
                ...
                <?php if(Route::has('password.request')): ?>
                    <a href="<?php echo e(route('password.request')); ?>" class="text-xs text-blue-500 hover:underline font-medium">
                        Lupa Password?
                    </a>
                <?php endif; ?>
            </div>
        ...
        <p class="text-center text-sm text-gray-500 mt-6">
            Belum punya akun?
            <a href="<?php echo e(route('register')); ?>" class="text-blue-500 font-bold hover:underline">
                Register
            </a>
        </p>
...
<?php echo $__env->make('layouts.auth', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\projek pak fajar\market-handphone\resources\views/auth/login.blade.php ENDPATH**/ ?>