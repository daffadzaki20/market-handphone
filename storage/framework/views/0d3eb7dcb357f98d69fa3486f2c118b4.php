            ...
            <nav class="space-y-5 text-sm">
                ...
                <div>
                   ...
                   <div class="pl-7 space-y-3 mt-2">
                    <a href="<?php echo e(route('profile.edit')); ?>" class="block text-orange-500 font-medium">Profil</a>
        ...
        <div class="flex-1 bg-white shadow-sm border border-gray-100 rounded-md p-6 md:p-8">  
            ...
            <div class="flex flex-col-reverse md:flex-row gap-8">
                ...
                <div class="w-full md:w-1/3 flex flex-col items-center pt-2">
                    ...
                    <form action="<?php echo e(route('profile.photo')); ?>" method="POST" enctype="multipart/form-data" id="photoForm" class="flex flex-col items-center">
                        <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\projek pak fajar\market-handphone\resources\views/user/profile/index.blade.php ENDPATH**/ ?>