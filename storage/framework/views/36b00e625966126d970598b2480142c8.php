...
<div class="max-w-6xl mx-auto px-4 py-6 md:py-8 flex flex-col md:flex-row gap-4 md:gap-3">
    ...
    <div class="w-full md:w-48 flex-shrink-0">
        ...
        <nav class="space-y-5 text-sm">
            ...
            <a href="/profile/voucher" class="flex items-center gap-2 font-semibold text-orange-500 transition-colors">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\S6\PengemWeb\market-handphone\resources\views/profile/voucher.blade.php ENDPATH**/ ?>