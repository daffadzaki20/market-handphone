    ...
    <div class="py-8">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div class="relative z-10 p-10 md:p-16 lg:p-20 text-white">
                    <h1 class="text-4xl md:text-6xl font-black mb-6 tracking-tight leading-tight animate-fade-in-up flex flex-wrap items-center justify-start gap-4">
                        ...
                        <?php if(auth()->guard()->check()): ?>
                            <span>Halo, <span class="text-yellow-300"><?php echo e(Auth::user()->name); ?>!</span></span>
                        <?php else: ?>
            ...
            <div id="kategori" class="grid grid-cols-1 md:grid-cols-2 gap-8 mb-16">
                <!-- KATEGORI HP -->
                <a href="<?php echo e(route('products.handphone')); ?>" class="relative overflow-hidden bg-white p-8 rounded-3xl shadow-sm border border-gray-100 hover:shadow-xl hover:-translate-y-2 transition-all duration-500 group">
                ...
                <!-- KATEGORI AKSESORIS -->
                <a href="<?php echo e(route('products.aksesoris')); ?>" class="relative overflow-hidden bg-white p-8 rounded-3xl shadow-sm border border-gray-100 hover:shadow-xl hover:-translate-y-2 transition-all duration-500 group">
                    <div class="absolute top-0 right-0 p-4 opacity-5 group-hover:opacity-10 transition-opacity">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\projek pak fajar\market-handphone\resources\views/user/dashboard.blade.php ENDPATH**/ ?>