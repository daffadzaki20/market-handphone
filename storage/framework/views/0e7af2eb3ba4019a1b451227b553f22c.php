            ...
            <nav class="space-y-5 text-sm">
                ...
                <div>
                   ...
                   <div class="pl-7 space-y-3 mt-2">
                    <a href="<?php echo e(route('profile')); ?>" class="block text-orange-500 font-medium">Profil</a>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\S6\PengemWeb\market-handphone\resources\views/user/profile/index.blade.php ENDPATH**/ ?>