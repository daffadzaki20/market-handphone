...
<div x-data="{ sidebarOpen: false }" class="flex h-screen overflow-hidden relative">
    ...
    <aside class="fixed inset-y-0 left-0 z-50 w-72 bg-white border-r border-blue-100 shadow-2xl flex flex-col transition-transform duration-300 ease-in-out md:relative md:translate-x-0"
        ...
        <nav class="flex-1 p-5 space-y-3 bg-white overflow-y-auto">
            ...
            <a href="<?php echo e(route('admin.dashboard')); ?>" class="flex items-center gap-4 px-5 py-4 rounded-2xl transition-all duration-300 <?php echo e(request()->is('admin') ? 'bg-gradient-to-r from-blue-500 to-cyan-400 text-white shadow-lg scale-[1.02]' : 'text-gray-600 hover:bg-blue-50 hover:text-blue-600 hover:shadow-md'); ?>">
                <span class="text-xl">📊</span><span class="font-semibold">Dashboard</span>
            </a>

            
            <a href="<?php echo e(route('admin.handphones.index')); ?>" class="flex items-center gap-4 px-5 py-4 rounded-2xl transition-all duration-300 <?php echo e(request()->is('admin/handphones*') ? 'bg-gradient-to-r from-blue-500 to-cyan-400 text-white shadow-lg scale-[1.02]' : 'text-gray-600 hover:bg-blue-50 hover:text-blue-600 hover:shadow-md'); ?>">
                <span class="text-xl">📱</span><span class="font-semibold">Handphone</span>
            </a>

            
            <a href="<?php echo e(route('admin.aksesoris.index')); ?>" class="flex items-center gap-4 px-5 py-4 rounded-2xl transition-all duration-300 <?php echo e(request()->is('admin/aksesoris*') ? 'bg-gradient-to-r from-blue-500 to-cyan-400 text-white shadow-lg scale-[1.02]' : 'text-gray-600 hover:bg-blue-50 hover:text-blue-600 hover:shadow-md'); ?>">
                <span class="text-xl">🎧</span><span class="font-semibold">Aksesoris</span>
            </a>

            
            <a href="<?php echo e(route('admin.users.index')); ?>" class="flex items-center gap-4 px-5 py-4 rounded-2xl transition-all duration-300 <?php echo e(request()->is('admin/users*') ? 'bg-gradient-to-r from-blue-500 to-cyan-400 text-white shadow-lg scale-[1.02]' : 'text-gray-600 hover:bg-blue-50 hover:text-blue-600 hover:shadow-md'); ?>">
                <span class="text-xl">👥</span><span class="font-semibold">Users</span>
            </a>

            
            <a href="<?php echo e(route('admin.orders.index')); ?>" class="flex items-center gap-4 px-5 py-4 rounded-2xl transition-all duration-300 <?php echo e(request()->is('admin/orders*') ? 'bg-gradient-to-r from-blue-500 to-cyan-400 text-white shadow-lg scale-[1.02]' : 'text-gray-600 hover:bg-blue-50 hover:text-blue-600 hover:shadow-md'); ?>">
...
</html><?php /**PATH D:\XampUtama\htdocs\handphone\resources\views/layouts/app_admin.blade.php ENDPATH**/ ?>