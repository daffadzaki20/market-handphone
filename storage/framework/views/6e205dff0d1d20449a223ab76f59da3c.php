...
<div class="max-w-6xl mx-auto px-4 py-6 md:py-8 flex flex-col md:flex-row gap-4 md:gap-3">
        ...
        <nav class="space-y-5 text-sm">
            <div>
                ...
                <div class="pl-7 space-y-3 mt-2">
                    ...
                    <a href="<?php echo e(route('profile.bank')); ?>" class="block text-orange-500 font-medium">Bank & Kartu</a>
    ...
    <div class="flex-1 bg-white shadow-sm border border-gray-100 rounded-md p-6 md:p-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-10">
            <?php $__empty_1 = true; $__currentLoopData = $kartu; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <div class="bg-gradient-to-r from-slate-800 to-slate-900 rounded-xl p-5 text-white shadow-lg relative overflow-hidden group hover:-translate-y-1 transition-transform">
                    ...
                    <div class="relative z-10">
                        ...
                        <div class="font-mono text-lg tracking-[0.2em] mb-1 shadow-sm" id="card-number-<?php echo e($item->id); ?>">
                            •••• •••• •••• <?php echo e(substr($item->account_number, -4)); ?>

                        </div>

                        
                        <div class="text-xs text-slate-400 mb-4">
                            CVV: <span id="cvv-<?php echo e($item->id); ?>">•••</span>
                        </div>

                        <div class="flex justify-between items-end mt-2">
                            <div class="font-medium uppercase text-sm tracking-widest text-slate-300"><?php echo e($item->account_name); ?></div>
                            <div class="flex items-center gap-3">
                                
                                <button type="button" onclick="openRevealModal(<?php echo e($item->id); ?>)" 
                                ...
                                <form action="<?php echo e(route('profile.bank.destroy', $item->id)); ?>" method="POST" onsubmit="return confirm('Yakin ingin menghapus kartu ini?');">
                                    <?php echo csrf_field(); ?>
...
<div id="modalTambahKartu" class="fixed inset-0 z-50 hidden overflow-y-auto bg-gray-900/60 backdrop-blur-sm" aria-labelledby="modal-title" role="dialog" aria-modal="true">
    <div class="flex items-end justify-center min-h-screen px-4 pt-4 pb-20 text-center sm:block sm:p-0">
        ...
        <div class="relative inline-block w-full px-4 pt-5 pb-4 overflow-hidden text-left align-bottom transition-all transform bg-white rounded-2xl shadow-xl sm:my-8 sm:align-middle sm:max-w-lg sm:p-6 sm:px-8">
            ...
            <form action="<?php echo e(route('profile.card.store')); ?>" method="POST" class="space-y-4">
                <?php echo csrf_field(); ?>
                <div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\projek pak fajar\market-handphone\resources\views/user/profile/bank.blade.php ENDPATH**/ ?>