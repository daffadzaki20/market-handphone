        ...
        <nav class="bg-white shadow-md relative z-[50]">
            <div class="max-w-7xl mx-auto px-4 py-3 flex justify-between items-center">
                ...
                <div class="hidden md:flex space-x-8 text-sm font-bold">
                    ...
                    <a href="<?php echo e(route('handphone.index')); ?>" class="pb-1 transition-colors duration-200 <?php echo e(request()->is('products/handphone') ? 'text-blue-600 border-b-2 border-blue-600' : 'text-gray-500 hover:text-blue-500'); ?>">
                        Handphone
                    </a>
                    <a href="<?php echo e(route('aksesoris.index')); ?>" class="pb-1 transition-colors duration-200 <?php echo e(request()->is('products/aksesoris') ? 'text-blue-600 border-b-2 border-blue-600' : 'text-gray-500 hover:text-blue-500'); ?>">
                        Aksesoris
                    </a>
...
</html><?php /**PATH D:\S6\PengemWeb\market-handphone\resources\views/layouts/app.blade.php ENDPATH**/ ?>